...
let shaderOptions: [ShaderOption] = [
    ...
    ShaderOption(id: 20, name: "Seurat",             desc: "2D P22 phosphor dots, triangular dot-pitch, convergence error, motion bloom"),
]
...
let shaderParamDefs: [UInt32: [ShaderParam]] = [
    ...
    20: [ // Seurat
        ...
        ShaderParam(name: "Glow",   min: 0.0, max: 2.0,  defaultValue: 0.60),
        ShaderParam(name: "Mask",   min: 0.0, max: 1.0,  defaultValue: 0.90),
        ShaderParam(name: "Bloom",  min: 0.0, max: 3.0,  defaultValue: 0.80),
    ],
]
